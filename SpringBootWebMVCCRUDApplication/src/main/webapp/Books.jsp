...
<h2>Programming</h2>
<p>Here we have all types and all versions of books related to programming languages!!.</p>
...
<h2>Research</h2>
<p>If you have huge interest in doing reserach,
    Here you can find ample off books related to the domain you are interested in!!</p>
<ion-icon class="arrow" name="arrow-forward-outline"></ion-icon>
...
<p>We also have the books related to current affairs!!.</p>
<ion-icon class="arrow" name="arrow-forward-outline"></ion-icon>
<a href="/customerlogin">Find here</a>
</div>
</div>
