...
.full-page
{
    height: 100%;
	width: 100%;
	background-image: linear-gradient(rgba(0,0,0,0.4),rgba(0,0,0,0.4)),url(images/cus3.png);
...
<align=center style="color: white">New User &nbsp <a href="addcustomer" class="btn">Register Here</a>
